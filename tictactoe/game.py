...
class TicTacToe:
    ...
    def avialable_move(self):
        ...
        #return moves = [ i for i in range enumerate(self.board) if spot == ' ']
    def empty_squares(self):
        return ' ' in self.board
    def num_empty_square(self):
        return self.board.count(' ')
    def make_move(self, square, letter):
         #if valid move, then male move(assign square to letter)
...
def play(game, x_player, o_player, print_game=True):
    ...
    #iterate while having the game still has empty squares
    #(we don't have to worry about winner because we'll just return to that
